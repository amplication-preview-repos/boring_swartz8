  ...
  test("POST /profiles", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        upcomingRenewals: CREATE_RESULT.upcomingRenewals.toISOString(),
      ...
      .expect([
        {
          ...
          upcomingRenewals: FIND_MANY_RESULT[0].upcomingRenewals.toISOString(),
  ...
  test("GET /profiles/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        upcomingRenewals: FIND_ONE_RESULT.upcomingRenewals.toISOString(),
